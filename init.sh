...
REQUIRED_PACKAGES="flask flask-mail flask-cors email-validator matplotlib openmeteo-requests requests-cache retry-requests flask_sqlalchemy pymysql flask_migrate openpyxl openai torch"
CONDA_REQUIRED_PACKAGES="flask email-validator matplotlib pandas openpyxl"
CONDA_REQUIRED_PIP_PACKAGES="flask-mail flask-cors openmeteo-requests requests-cache retry-requests flask_sqlalchemy pymysql flask_migrate openai torch"
