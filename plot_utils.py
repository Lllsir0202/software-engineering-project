...
valid_metrics = ["Weight(g)", "Height(cm)", "Width(cm)",
                 "Length1(cm)", "Length2(cm)", "Length3(cm)"]

def get_valid_metrics():
    return valid_metrics

def plot_average_by_species(metric):
    ...
    # 创建自定义配色方案
    custom_colors = ['#3498db', '#2ecc71', '#e74c3c', '#f39c12', '#9b59b6', '#1abc9c', '#34495e']
